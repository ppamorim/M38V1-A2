...
void setup()   {
  ...
  // Draw the dial
  TJpgDec.drawJpg(0, 0, smile_0, sizeof(smile_0));
...
void loop() {
  ...
  TJpgDec.drawJpg(0, 0, smile_0, sizeof(smile_0));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_1, sizeof(smile_1));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_2, sizeof(smile_2));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_3, sizeof(smile_3));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_4, sizeof(smile_4));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_5, sizeof(smile_5));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_6, sizeof(smile_6));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_7, sizeof(smile_7));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_8, sizeof(smile_8));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_9, sizeof(smile_9));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_10, sizeof(smile_10));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_11, sizeof(smile_11));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_12, sizeof(smile_12));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_13, sizeof(smile_13));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_14, sizeof(smile_14));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_15, sizeof(smile_15));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_16, sizeof(smile_16));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_17, sizeof(smile_17));
  delay(delayDuration);
  TJpgDec.drawJpg(0, 0, smile_18, sizeof(smile_18));
